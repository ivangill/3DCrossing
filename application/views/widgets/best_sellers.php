...
$best_seller= $this->mongodb->db->selectCollection("product_buy")->aggregate(array('$group' => array('_id'=>'$product_owner_id','count'=>array('$sum'=>1))),array('$sort'=>array('count'=>-1)), array('$limit'=>1));
if (isset($best_seller['result'][0]['_id'])) {
