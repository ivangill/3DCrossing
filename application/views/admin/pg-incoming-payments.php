...
<div style="float:right">
 <a class="btn btn-primary" href="<?php echo base_url('administration/payments/export_incoming_payments/') ?>" style="color:white;" target="_blank">Export Incoming Payments</a>
 
</div>
<div class="span3 pull-right" style="border:1px solid #e8e8e8;background-color:#fcfcfc;padding:8px;">
 <?php echo "Total Incoming Payments are: <span class='label label-important'>$ ".$total.'</span>'; ?>
 </div>
 <h2 class="withbtn">Incoming Payments</h2>
