...
<?php echo $this->session->flashdata('response'); ?>
 <form class="form-signin" method="POST" action="<?php echo base_url('administration/settings/global_settings'); ?>">
      	<label>Amount For Review Cut (%): [0-9]</label><input type="text" pattern= "[0-9.]+" class="span4" required="required" name="review_cut" class="input-block-level" placeholder="Enter Review Cut">
