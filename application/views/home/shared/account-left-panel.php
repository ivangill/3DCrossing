...
<li <?php if ($this->uri->segment(2)=="get_payments" || $this->uri->segment(2)=="get_paid") { ?> class="active" <?php } ?>><a href="<?php echo base_url('member/get_payments'); ?>">My Payments</button></a></li>
</ul>
 </div>