...
<div class="span2 pull-right" style="border:1px solid #e8e8e8;background-color:#fcfcfc;padding:8px;">
 <?php  
  $total = 0;
 ...
 echo "Total Earnings: <span class='label label-important'>$ ".$total.'</span>'; ?>
 <br />
 <?php  
  $total = 0;
 ...
 echo "Total Pending Earnings: <span class='label label-important'>$ ".$total.'</span>'; ?>
 </div>
 <div class="span7">
	...
	<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped display" id="example" width="100%">
        ...
        <tbody>
         ...
         <?php foreach($get_sold_products as $product) { ?> 
          ...
          <a class="btn btn-info btn-small" data-toggle="modal" href="<?php echo base_url(); ?>member/get_paid/<?php echo $product['_id']; ?>">Get payment</a>
          <?php } ?>
